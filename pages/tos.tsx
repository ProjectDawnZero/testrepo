  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="mb-4 text-gray-700">
        By using this directory, you agree to these terms. This site is for adults only. You must be
        at least 18 years old (or the age of majority in your jurisdiction) to access this website.
      </p>
