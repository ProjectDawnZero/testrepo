  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="mb-4 text-gray-700">
        We respect intellectual property rights. This directory links to third-party sites and does
        not host content. If you believe your copyrighted work has been infringed on a linked site,
